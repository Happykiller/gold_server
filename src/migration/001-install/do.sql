...
CREATE TABLE `user` (
  ...
  `creation` datetime NOT CURRENT_TIMESTAMP,
...
CREATE TABLE `operation` (
  ...
  CONSTRAINT `operation-creator` FOREIGN KEY (`creator_id`) REFERENCES `api_tab_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `operation-modificator` FOREIGN KEY (`modificator_id`) REFERENCES `api_tab_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `operation_status_list` (
  ...
  KEY `operation_status_list-creator` (`creator_id`),
  KEY `operation_status_list-modificator` (`modificator_id`),
  CONSTRAINT `operation_status_list-creator` FOREIGN KEY (`creator_id`) REFERENCES `api_tab_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `operation_status_list-modificator` FOREIGN KEY (`modificator_id`) REFERENCES `api_tab_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
